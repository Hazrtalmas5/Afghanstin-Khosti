...
# ![Khosti](https://raw.githubusercontent.com/video-dev/hls.js/master/docs/logo.svg)
...
Khosti works directly on top of a standard HTML`<video>` element.

Khosti is written in [ECMAScript6] (`*.js`) and [TypeScript] (`*.ts`) (strongly typed superset of ES6), and transpiled in ECMAScript5 using [Babel](https://babeljs.io/) and the [TypeScript compiler].
...
### They use HazrtKhosti in production!
